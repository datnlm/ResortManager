                    ...
                    <a class="list-group-item">
                        <div class="media col-md-3">
                            <figure class="pull-left">
                                <img class="media-object img-rounded img-responsive" src="http://villadelangelhotel.com/wp-content/uploads/2018/12/%c3%81reas-Comunes-2-350x250.png" alt="placehold.it/350x250" >
                            </figure>
                        </div>
                        <div class="col-md-6">
